        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">buat akun sekarang 🚀</h4>
              <!-- <p class="mb-4">Make your app management easy and fun!</p> -->
              <div id="hilang">
                  <?= $this->session->flashdata('alert'); ?>
                </div>
              <form id="formAuthentication" class="mb-3" action="<?= base_url('auth/buat_akun') ?>" method="POST">
                <div class="mb-3">
                ...
                <div class="row">
                 <div class="col mb-3">
                   ...
                   <select name="level" class="form-control">
                     <option value="Kontributor" selected>Member</option>
                   </select>
                 </div>
               </div>
